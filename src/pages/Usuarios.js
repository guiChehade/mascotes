          ...
          {users.map((user) => (
            <tr key={user.id}>
              ...
              <td>
                {user.role === 'isOwner' ? (
                  <>
                    <button disabled title="Não é possível editar ou excluir Proprietários, caso seja necessário contate o Guilherme Chehade">Editar</button>
                    <button disabled title="Não é possível editar ou excluir Proprietários, caso seja necessário contate o Guilherme Chehade">Excluir</button>
                  </>
                ) : (
                  editUserId === user.id ? (
