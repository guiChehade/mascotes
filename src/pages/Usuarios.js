  ...
  const handleRegister = async (e) => {
    ...
    try {
      const docRef = await addDoc(collection(firestore, 'users'), {
        ...
        createdBy: currentUser ? currentUser.displayName : 'Site',
      });
                ...
                {editUserId === user.id ? (
                  ...
                  <>
                    <button 
                      ...
                      disabled={user.roles === 'Owner'} 
                      title={user.roles === 'Owner' ? 'Não é possível editar ou excluir Proprietários, caso seja necessário contate o Guilherme Chehade.' : ''}
                    >
                      Editar
                    </button>
                    <button 
